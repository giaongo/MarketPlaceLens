...
const translations = {
  en: {
    ...
    "settings.facebookGuideStep3": "If Facebook blocks anonymous server access, copy the Cookie value, the Cookie: line, or the full request headers from one of your own browser requests to facebook.com and paste it below.",
    ...
    "settings.facebookCookieHint": "Use only your own account/session. You can paste just c_user=...; xs=..., a Cookie: line, or a full browser request header block. Leave ******** unchanged to keep the saved cookie.",
  ...
  de: {
    ...
    "settings.facebookGuideStep3": "Wenn Facebook anonymen Serverzugriff blockiert, kopiere den Cookie-Wert, die Cookie:-Zeile oder den kompletten Request-Header-Block aus einer eigenen Browser-Anfrage an facebook.com und füge ihn unten ein.",
    ...
    "settings.facebookCookie": "Cookie-Header",
    "settings.facebookCookieHint": "Nur mit deinem eigenen Account/deiner eigenen Session nutzen. Du kannst nur c_user=...; xs=..., eine Cookie:-Zeile oder einen kompletten Browser-Request-Header-Block einfügen. ******** unverändert lassen, um den gespeicherten Cookie zu behalten.",
